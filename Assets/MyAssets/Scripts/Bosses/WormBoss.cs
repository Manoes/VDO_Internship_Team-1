...
{
    [Header("Audio")]
    [SerializeField] private AudioSource bodyDestroyedAudio;
    [SerializeField] private AudioSource headVulnerableAudio;
    ...
    public void DamageWormBody()
    {
        ...
        bodyDestroyedAudio?.PlayOneShot(bodyDestroyedAudio.clip);
    ...
    private void MakeHeadVulnerable()
    {
        ...
        headVulnerable = true;
        headVulnerableAudio?.PlayOneShot(headVulnerableAudio.clip);
